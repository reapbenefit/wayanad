  ...
  function makeGeoJSON(csvData) {
    csv2geojson.csv2geojson(
      ...
      function (err, data) {
        ...
        color1data["features"] = color1data["features"].filter(
          (color1data) => color1data["properties"].rainfall <= 29
        );
        ...
        color2data["features"] = color2data["features"].filter(
          (color2data) => color2data["properties"].rainfall >= 30
        );
        ...
        filterData["features"] = filterData["features"].filter(
          (filterData) => filterData["properties"].Category === "filterData"
        );
